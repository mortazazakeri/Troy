...
<html>
    ...
    <body style="margin-left: 25%; margin-right: 25%; margin-top: 1%">
        ...
        <header class="w3-container w3-blue w3-round-xlarge">
            <h1 class="w3-margin w3-jumbo w3-center w3-hover-text-indigo">Sign in</h1>
        </header>
        <form class="w3-container w3-center" style="margin-top: 5%" action="./loginprocess.jsp" method="post">
            <div class="w3-container w3-left-align">
                ...
                <input class="w3-btn w3-round-large w3-center" style="width: 25%; margin-left: 37.5%; margin-top: 10%" type="submit" value="Login">
            </div>
            <a class="w3-hover-text-red" href="../index.jsp"> Home Page </a> 
            | 
            <a class="w3-hover-text-red" href="./register.jsp"> Register </a>
        </form>
    </body>
</html>