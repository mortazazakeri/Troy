...
<html>
    <head>
        ...
        <title>TaxiFinder - Passenger Delete</title>
        <%
    ...
    <body>
        ...
        <%
              ...
              db.ODBClass.getInstance().deleteUser(username);
            if (session.getAttribute("role").equals("passenger") == true)
            {
                session.invalidate();
